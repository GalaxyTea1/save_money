...
const Categories = () => {
    ...
    return (
        <div className='space-y-6'>
                ...
                {categories.map((category) => (
                    ...
                    >
                        ...
                        <div className='pt-4'>
                            ...
                            {category.icon && <span className='text-2xl mb-2 block text-gray-900 dark:text-white'>{category.icon}</span>}
                        </div>
                    </div>
                ))}
            </div>
            ...
            {isModalOpen ? (
                <CategoryModal isOpen={isModalOpen} onClose={handleClose} category={selectedCategory} key={selectedCategory?.id || "new"} />
            ) : null}
        </div>
    );
};
